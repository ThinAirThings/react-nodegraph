...
type LifeCycleHandlers<InputNodes extends ReadonlyArray<AirNode<any, any>>, OutputNode extends AirNode<any, any>> = Required<Required<Parameters<typeof useEdge<InputNodes, NodeValue<OutputNode>>>>[2]>['lifecycleHandlers'];
